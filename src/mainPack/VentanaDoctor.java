...
public class VentanaDoctor extends JFrame {
	...
	public VentanaDoctor() {
		...
		lblDocumento.setBounds(508, 508, 150, 55);
		lblDocumento.setBackground(new Color(0, 128, 192));
		panel.add(lblDocumento);

		// Establecemos el tamaño y su fuente
		lblDocumento.setFont(fuenteLabel);
		lblDocumento.setBackground(Color.decode("#008cce"));
		...
		label_Direccion.setBounds(520, 168, 93, 38);
		...
		label_IDEspecialidad.setBounds(508, 446, 150, 38);
		...
		label_Email.setBounds(520, 310, 62, 38);

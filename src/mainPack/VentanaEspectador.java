...
public class VentanaEspectador extends JFrame {
	...
	public VentanaEspectador() {
		...
		VentanaEspectador.this.setIconImage(icono1.getImage());
		...
		botonAñadir3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Cierra la ventana actual (VentanaEspectador)
				dispose();
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (conector.conexion != null) {
						...
						JOptionPane.showMessageDialog(VentanaEspectador.this, "Error al conectar con la base de datos",
					...
					ex.printStackTrace();
					JOptionPane.showMessageDialog(VentanaEspectador.this, "Error al cargar los datos de pacientes",
							"Error", JOptionPane.ERROR_MESSAGE);
				}
		...
		button2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ex.printStackTrace();
					JOptionPane.showMessageDialog(VentanaEspectador.this, "Error al cargar los datos de doctor",
							"Error", JOptionPane.ERROR_MESSAGE);
				}
		...
		button3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {   
					...
					ex.printStackTrace();
					JOptionPane.showMessageDialog(VentanaEspectador.this, "Error al cargar los datos de citas",
							"Error", JOptionPane.ERROR_MESSAGE);
				}
		...
		button4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ex.printStackTrace();
					JOptionPane.showMessageDialog(VentanaEspectador.this, "Error al cargar los datos de material",
							"Error", JOptionPane.ERROR_MESSAGE);
				}
